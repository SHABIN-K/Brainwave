      ...
      <div className="p-8 bg-white shadow mt-24 md:mt-14">
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="relative">
            <figure className="w-48 h-48 bg-indigo-100 mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 -mt-24 flex items-center justify-center text-indigo-500 ">
              <Image  src={session?.user?.image || ''}alt="user avatar"  width={200}
